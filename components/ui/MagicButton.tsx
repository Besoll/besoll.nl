...
const MagicButton = ({
  ...
  return (
    <button className={`relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none w-full md:w-60 md:mt-10 text-white ${otherClassesButton}`} onClick={handleClick}>
