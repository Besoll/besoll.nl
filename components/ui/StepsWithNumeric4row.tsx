...
export const StepsWithNumeric4row = ({
  ...
  return (
    <div className="w-full grid grid-cols-1 md:gap-4 md:px-1 mb-2 " id='stepsBuild'>
        {steps.map((step) => (
            <div key={step.id} className={`w-full flex flex-row justify-center items-start gap-4 rounded-xl p-4 md:p-2 md:m-1 md:mx-1 
